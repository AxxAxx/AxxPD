...
struct PD_TIMEOUT {
    ...
    static constexpr Type tTypeCSinkWaitCap {PD_TIMER::PE_SinkWaitCapTimer, 2000 * ms_mult}; // Extended to 2s for chargers that do SOP' cable discovery first
    static constexpr Type tSenderResponse {PD_TIMER::PE_SenderResponseTimer, 33 * ms_mult}; // Spec: 27-36 ms
    ...
    static constexpr Type tPSTransition_EPR {PD_TIMER::PE_PSTransitionTimer, 3000 * ms_mult}; // 830-1020 ms spec; relaxed to 3 s for Anker A2697 28 V transition
