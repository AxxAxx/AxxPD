...
// DEBUG: PRL RX message ID tracking counters
volatile uint32_t prl_rx_dup = 0;
volatile uint32_t prl_rx_new = 0;
volatile int8_t prl_rx_last_stored = -99;
volatile int8_t prl_rx_last_incoming = -99;
volatile uint8_t prl_rx_last_msgtype = 0;
...
public:
    static auto on_enter_state(PRL_Rx& prl_rx) -> state_id_t {
        ...
        // DEBUG counters for message ID tracking (extern for heartbeat)
        ...
        prl_rx_last_stored = port.rx_msg_id_stored;
        prl_rx_last_incoming = port.rx_chunk.header.message_id;
        prl_rx_last_msgtype = port.rx_chunk.header.message_type;
        (void)prl_rx_last_stored; (void)prl_rx_last_incoming; (void)prl_rx_last_msgtype;
