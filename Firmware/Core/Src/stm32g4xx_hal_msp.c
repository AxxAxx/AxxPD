...
void HAL_MspInit(void)
{
  ...
  /* Dead battery pull-downs (Rd on CC) stay enabled until UCPD takes over.
   * Disabling here would remove Rd before UCPD init, causing the source
   * to cut VBUS → boot loop. Moved to main() after MX_UCPD1_Init(). */
