...
/* Enable only needed fonts — keep flash usage minimal */
#define UGUI_USE_FONT_arial_17X18          /* SM: 18px, full ASCII */
#define UGUI_USE_FONT_arial_23X24          /* MD: 24px, full ASCII */
#define UGUI_USE_FONT_arial_35X26          /* LG: 26px, numbers+A+W */
#define UGUI_USE_FONT_arial_35X37          /* 37px, numbers+V (legacy) */
#define UGUI_USE_FONT_arial_49X37          /* XL: 37px, numbers+V+A+W */
/* Feature enablers */
